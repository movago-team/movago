      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-soft">
        <img
          ...
          className={`h-full w-full object-cover transition duration-700 ease-out group-hover:scale-[1.035] ${
            isAvailable ? '' : 'grayscale-[35%] opacity-75'
          }`}
        />
      ...
      <div className="flex flex-1 flex-col p-6 sm:p-7">
        ...
        <div className="mt-auto pt-7">
          <div className="flex items-end justify-between gap-4">
            ...
            <p className="pb-1 text-xs text-muted">/ วัน</p>
          </div>
          ...
          >
            {isAvailable ? 'จองรถคันนี้' : 'ถูกจองแล้ว'}
          </button>
        </div>
      </div>
    </article>
...
export default function TestPage() {
  const availableCars = cars.filter((car: Car) => car.is_available).length;
        ...
        <div className="grid items-end gap-8 border-b border-line pb-12 lg:grid-cols-[1fr_auto] lg:pb-14">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-5 font-display text-5xl font-medium leading-[0.95] tracking-[-0.045em] text-ink sm:text-6xl lg:text-7xl">
              การเดินทาง
              <span className="block italic text-ink/65">ที่เหนือระดับ</span>
            </h1>

            <p className="mt-7 max-w-xl text-sm font-light leading-7 text-muted sm:text-base">
              คอลเลกชันรถยนต์ระดับพรีเมียม ที่คัดสรรเพื่อมอบประสบการณ์การเดินทาง
          ...
          <div className="flex gap-8 lg:pb-1">
            <div>
              <p className="font-display text-3xl text-ink">{cars.length}</p>
            ...
            <div className="border-l border-line pl-8">
              <p className="font-display text-3xl text-ink">{availableCars}</p>
