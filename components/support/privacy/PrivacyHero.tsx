...
import { PRIVACY_HERO_FEATURES } from '@/data/support'
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <Image
          src="/images/support/privacy-hero.png"
          alt="MOVAGO Privacy Policy"
          fill
          priority
          sizes="100vw"
        ...
        <div
          aria-hidden
          className="block sm:hidden absolute inset-0 z-0 bg-[url('/images/support/privacy-hero.png')] bg-no-repeat bg-[length:140%_auto] bg-[position:80%_30%] [filter:brightness(1.14)_contrast(1.05)]"
        />
      ...
      <div className="page-width-full relative z-[1] flex flex-col pt-[clamp(24px,3vw,40px)] max-[900px]:pt-10 max-[600px]:pt-5">
        <div className="max-w-[620px]">
          ...
          <p className="m-0 mt-3.5 max-w-[540px] font-sans text-base leading-relaxed text-[#d6d9d0]">
            At MOVAGO, we are committed to protecting your personal information and ensuring transparency about how we collect, use, and safeguard your data.
          </p>
        </div>
      </div>
      ...
      <div className="page-width relative z-[1] w-full mt-auto pt-10 sm:pt-12">
        <div className="overflow-hidden rounded-2xl border border-white/25 bg-[#090c0d]/85 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.15)] backdrop-blur-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {PRIVACY_HERO_FEATURES.map((feature, idx) => {
              const isNotLast = idx < PRIVACY_HERO_FEATURES.length - 1
              return (
                <div
                  key={feature.id}
